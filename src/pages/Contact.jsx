      ...
      <div className="out-contact">
        <div className="contact-main">
          ...
          <div className="contact-us">
            ...
            <div className="contact-us-blocks4">Customer Service : <br/><span className={`span-sale ${mainBool}`}>hello@bella.com</span></div>
            <div className="contact-us-blocks4">Gmail_of_creator of this site : <br/><span className={`span-sale ${mainBool}`}>Almazbekovnurgel@gmail.com</span> </div>  
          </div>
          ...
          <div className="contact-form">
            ...
            <button className={`button-shop-now ${mainBool}`}>send message</button>
          </div>
